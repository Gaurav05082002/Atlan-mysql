...
const Editor = () => {
  ...
  return (
    <div id="main">
      ...
      <div id="leftone">
        ...
        <button className="lbtn" onClick={setstll} id="minus">
          <GrActions />
        </button>
        <button
          className="lbtn"
  ...
  from here you can choose a file and then can view its data or edit its data or remove that file  */}
      <div id="lefttwo" style={{ width: size, visibility: visi }}>
        ...
        <ul class="list-group">
          <button className="filebtn" style={{ border: "0px" }} onClick={file1}>
            {" "}
            <li
              class="list-group-item"
              style={{ padding: "0.2rem", fontFamily: "Georgia" }}
              aria-current="true"
            >
              categories.csv
            </li>
          </button>
          <button className="filebtn" style={{ border: "0px" }} onClick={file2}>
            <li
              class="list-group-item"
              style={{ padding: "0.2rem", fontFamily: "Georgia" }}
            >
          ...
          <button className="filebtn" style={{ border: "0px" }} onClick={file3}>
            <li
              class="list-group-item"
              style={{ padding: "0.2rem", fontFamily: "Georgia" }}
            >
          ...
          <button className="filebtn" style={{ border: "0px" }} onClick={file4}>
            <li
              class="list-group-item"
              style={{ padding: "0.2rem", fontFamily: "Georgia" }}
            >
          ...
          <button className="filebtn" style={{ border: "0px" }} onClick={file5}>
            <li
              class="list-group-item"
              style={{ padding: "0.2rem", fontFamily: "Georgia" }}
            >
          ...
          <button className="filebtn" style={{ border: "0px" }} onClick={file6}>
            <li
              class="list-group-item"
              style={{ padding: "0.2rem", fontFamily: "Georgia" }}
            >
          ...
          <button className="filebtn" style={{ border: "0px" }} onClick={file7}>
            <li
              class="list-group-item"
              style={{ padding: "0.2rem", fontFamily: "Georgia" }}
            >
          ...
          <button className="filebtn" style={{ border: "0px" }} onClick={file8}>
            <li
              class="list-group-item"
              style={{ padding: "0.2rem", fontFamily: "Georgia" }}
            >
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <div class="mb-3">
                        ...
                        <textarea
                          class="form-control"
                          placeholder="hey, this query is performed on {file}"
                          id="message-text"
                        ></textarea>
                      </div>
                    </form>
