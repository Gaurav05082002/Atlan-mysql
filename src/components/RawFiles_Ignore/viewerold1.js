...
const Viewer = () => {
 ...
 //sorting 
  ...
  const changeText = (setText,  property) => {
  ...
  // const sortByIdAsc = () => {setFilterData(sortByAsc(filterData , "orderID"));}
        ...
        <thead>
          ...
          OrderID
            <Button
              ...
              color="primary"
              type="button"
              onClick={() => changeText(setText1,  "orderID")}
            >
              {text1 ? "▲" : "▼"}
            </Button>
          </th>
